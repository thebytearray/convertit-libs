...
Java_org_thebytearray_taglib_1android_TagLib_getAudioProperties(
        JNIEnv *env,
        jclass,
        jint fd,
        jint read_style
...
JNIEXPORT jobject JNICALL
Java_org_thebytearray_taglib_1android_TagLib_getMetadata(
        JNIEnv *env,
        jclass,
        jint fd,
...
Java_org_thebytearray_taglib_1android_TagLib_getMetadataPropertyValues(
        JNIEnv *env,
        jclass,
        jint fd,
...
JNIEXPORT jobjectArray JNICALL
Java_org_thebytearray_taglib_1android_TagLib_getPictures(
        JNIEnv *env,
        jclass,
        jint fd
) {
...
Java_org_thebytearray_taglib_1android_TagLib_savePropertyMap(
        JNIEnv *env,
        jclass,
        jint fd,
...
JNIEXPORT jboolean JNICALL
Java_org_thebytearray_taglib_1android_TagLib_savePictures(
        JNIEnv *env,
        jclass,
        jint fd,
        jobjectArray pictures
